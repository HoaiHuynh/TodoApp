...
const initialNodes: Node<CustomFlowNodeData>[] = [
    ...
    {
        id: '2',
        position: { x: 260.4412300683372, y: -60.327107061503426 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '3',
        position: { x: -25.523006833712984, y: 137.46674259681095 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '4',
        position: { x: 240.7189066059226, y: 128.18564920273346 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '5',
        position: { x: 497.6797266514807, y: 28.708656036446456 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '7',
        position: { x: 516.9931662870159, y: 245.78542141230065 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '8',
        position: { x: 258.69157175398635, y: 317.74441913439637 },
        data: {
            icon: (
                <svg
                    width={20}
    ...
    {
        id: '9',
        position: { x: -8.139863325740336, y: 351.38838268792716 },
        data: {
            icon: (
                <svg
                    width={20}
                ...
                <svg>
                    <defs>
                        <linearGradient id="edge-gradient">
                            <stop offset="0%" stopColor="#9394a0" />
                            <stop offset="100%" stopColor="#9394a0" />
                        </linearGradient>
